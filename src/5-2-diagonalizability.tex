...
\begin{proof}[\pf{ex:5.2.20}]
  ...
  Then we have
  \begin{align*}
             & \V = \W_1 \oplus \cdots \oplus \W_k                                                                &  & \text{(by \cref{5.2.7})}      \\
    \implies & \bigcup_{i = 1}^k \beta_i \text{ is an ordered basis for } \V \text{ over } \F                     &  & \text{(by \cref{5.10}(a)(d))} \\
    \implies & \dim(\V) = \#(\bigcup_{i = 1}^k \beta_i) = \sum_{i = 1}^k \#(\beta_i) = \sum_{i = 1}^k \dim(\W_i). &  & \text{(by \cref{1.6.8})}
  \end{align*}
  ...
  \begin{align*}
    ...
    \implies & \V = \W_1 \oplus \cdots \oplus \W_k. &  & \text{(by \cref{5.10}(a)(d))}
  \end{align*}
\end{proof}
...
\begin{proof}[\pf{ex:5.2.22}]
  ...
  \begin{align*}
         & v \in S                                                                             \\
    \iff & \exists i \in \set{1, \dots, k} : \T(v) = \lambda_i v &  & \text{(by \cref{5.1.2})} \\
    \iff & \exists i \in \set{1, \dots, k} : v \in E_{\lambda_i} &  & \text{(by \cref{5.2.4})} \\
...
\begin{proof}[\pf{ex:5.2.23}]
  ...
  \begin{align*}
    ...
    \implies & \W_1 + \W_2 = \W_1 \oplus \W_2                                                  &  & \text{(by \cref{5.2.7})} \\
