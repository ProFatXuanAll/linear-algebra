...
\begin{proof}
  ...
  and
  \begin{align*}
             & \forall A \in \ms{n}{n}{\F}, \begin{dcases}
      A_{i j} = B_{i j} + C_{i j} \\
      A_{j i} = -B_{i j} + C_{i j}
    \end{dcases} \text{ for some } B_{i j}, C_{i j} \in \F \\
    \implies & \forall A \in \ms{n}{n}{\F}, \begin{dcases}
