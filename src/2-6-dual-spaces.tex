...
\begin{proof}[\pf{ex:2.6.10}(b)]
  ...
  \begin{align*}
    ...
    \implies & \forall i, j \in \set{0, \dots, n}, p_i(c_j) = \delta_{i j}.               &  & \text{(by \cref{ex:2.6.10}(b))}
  \end{align*}
  Now we show that \(\beta\) is unique.
  Suppose for sake of contradiction that there exists a set \(\gamma = \set{\seq{q}{0,,n}}\) such that \(\beta \neq \gamma\), \(\gamma\) is an ordered basis for \(\ps[n]{\F}\) over \(\F\) and \(\beta^*\) is also the dual basis for \(\gamma\).
  ...
  But
  \begin{align*}
    \forall j \in \set{0, \dots, n}, q_0(c_j) & = \delta_{0 j}                     &  & \text{(by \cref{2.6.6})}      \\
...
\begin{proof}[\pf{ex:2.6.11}]
  ...
  \begin{align*}
    \pa{\pa{\tp{\tp{\T}} \psi_1}(x)}(y) & = \pa{\tp{\tp{\T}}(\psi_1(x))}(y)                                 \\
                                        ...
                                        & = ((\psi_2 \T)(x))(y).
  \end{align*}
  Thus we have \(\tp{\tp{\T}} \psi_1 = \psi_2 \T\).
\end{proof}
