...
\begin{note}
  ...
  Thus \(v\) determines an unique \(n\)-tuple of scalars \(\tuple{a}{1,,n}\) and, conversely, each \(n\)-tuple of scalars determines an unique vector \(v \in \V\) by using the entries of the \(n\)-tuple as the coefficients of a linear combination of \(\seq{u}{1,,n}\).
...
\begin{defn}[The Lagrange Interpolation Formula]\label{1.6.20}
  ...
  \[
    f_i(x) = \dfrac{(x - c_0) \cdots (x - c_{i - 1}) (x - c_{i + 1}) \cdots (x - c_n)}{(c_i - c_0) \cdots (c_i - c_{i - 1}) (c_i - c_{i + 1}) \cdots (c_i - c_n)} = \prod_{\substack{k = 0 \\ k \neq i}}^n \dfrac{x - c_k}{c_i - c_k}
  \]
