...
\begin{proof}[\pf{ex:1.6.29}(a)]
  ...
  \begin{align*}
             & \begin{dcases}
                 \forall v \in \beta_1, v = v + \zv \in \W_1 + \W_2 \\
                 \forall w \in \beta_2, w = \zv + w \in \W_1 + \W_2
  ...
  \begin{align*}
    ...
    \implies & \begin{dcases}
                 \spn{\beta_1} \cap (\beta_2 \setminus \beta) = \varnothing \\
                 \spn{\beta_2} \cap (\beta_1 \setminus \beta) = \varnothing
               \end{dcases}   \\
    \implies & \begin{dcases}
                 \spn{\beta_1} \cap \spn{\beta_2 \setminus \beta} = \set{\zv} \\
                 \spn{\beta_2} \cap \spn{\beta_1 \setminus \beta} = \set{\zv}
               \end{dcases},
  \end{align*}
  we know that
  \begin{align*}
